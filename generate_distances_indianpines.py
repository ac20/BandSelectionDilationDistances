...
from Data import get_indianpines_dataset


def generate_distance_matrix_indianpines():
    """
    """
    ...
    np.savetxt("./indianpines_distances.csv", DD, delimiter=',')


if __name__ == "__main__":
    generate_distance_matrix_indianpines()
